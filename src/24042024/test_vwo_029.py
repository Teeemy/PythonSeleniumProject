...
def test_vwologin_negative():
    ...
    # Fluent Wait is same with explicit wait. just that fluent wait has poll frequency
    ...
    # Explicit Wait - is Checking - t0,0,1,02,....till..5seconds
    # ExplicitWait - FluentWait ,  t1, 2, 3, 4, 5
